...
riot.tag2('search-result-compact-card', '<div class="card"> <div class="card-body"> <div class="row"> <div class="col-md-10"> <p> <a class="float-left" href="#/detail/{data.id}"><strong>{data.name}</strong></a> <ratings-cmp rating="{data.rating}"></ratings-cmp> </p> <div class="clearfix"></div> </div> <div class="col-md-2"> <img riot-src="{data.image_url}" class="img img-rounded img-fluid"> </div> </div> </div> </div>', '', '', function(opts) {
        var self = this;
        self.data = {}
        self.data.name = ''
        self.data.rating = ''
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var riot = __webpack_require__(0)
    riot.tag2('ratings-cmp', '{ratingVal} <virtual if="{rated}" each="{rating,i in ratings}"> <span class="float-left"> <i class="fa {getStarClass(i)}"></i> </span> </virtual>', '', 'class="float-right"', function(opts) {
        var self = this;
        self.rated = false
...
/* WEBPACK VAR INJECTION */(function($) {
    var riot = __webpack_require__(0)
    riot.tag2('restaurant-detail', '<div class="container m-5"> <div class="jumbotron jumbotron-fluid jumbotronImg" riot-style="{bgImg()}"> <div class="container"> <h1 class="display-4">{data.name}</h1> <p class="lead">{data.alias}. </p> </div> </div> <table class="table-striped table table-sm table-hover table-responsive"> <tbody> <tr> <th scope="row">is_claimed</th> <td>{data.is_claimed}</td> </tr> <tr> <th scope="row">Is Closed</th> <td>{data.is_closed}</td> </tr> <tr> <th scope="row">yelp</th> <td>{data.url}</td> </tr> <tr> <th scope="row">phone</th> <td>{data.phone}</td> </tr> <tr> <th scope="row">review_count</th> <td>{data.review_count}</td> </tr> <tr> <th scope="row">rating</th> <td>{data.rating}</td> </tr> <tr> <th scope="row">price</th> <td>{data.price}</td> </tr> <tr> <th scope="row">rating</th> <td>{data.rating}</td> </tr> </tbody> </table> </div>', '', '', function(opts) {
        var self = this;
        self.data = {}
        self.data.image_url = ""
        self.bgImg = function () {
